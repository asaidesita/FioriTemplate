sap.ui.define([
	...
	return Opa5.extend("ns11.HTML5Module.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ns11/HTML5Module/localService/mockserver"], function (mockserver) {
